...
const file_proto_user_user_proto_rawDesc = "" +
	...
	".user.User\x129\n" +
	"\bGetUsers\x12\x15.user.GetUsersRequest\x1a\x16.user.GetUsersResponseB?Z=github.com/AbhiramiRajeev/event-ticketing-platform/proto/userb\x06proto3"
